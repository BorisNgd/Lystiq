...
public class FailedExchange extends Fragment implements FragmentChangeListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    private void getFailedExchanges() {
        StringRequest req = new StringRequest(Request.Method.POST, Constants.API_MY_EXCHANGE, new Response.Listener<String>() {
            ...
            public void onResponse(final String json) {
                Log.v(TAG,"getFailedExchangesRes="+json);
                if (pulldown) {
                    failedAry.clear();
                }
    ...
    public class ExchangeAdapter extends BaseAdapter {
        ArrayList<HashMap<String, String>> failedExchangeList;
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            try {
                final HashMap<String, String> tempMap = failedExchangeList.get(position);
                ...
                holder.view.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        i.putExtra(Constants.DATA, failedExchangeList.get(position));
