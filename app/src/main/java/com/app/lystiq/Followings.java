...
public class Followings extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void getFollowings(final int pageCount) {
        StringRequest req = new StringRequest(Request.Method.POST, Constants.API_FOLLOWINGS, new Response.Listener<String>() {
            ...
            public void onResponse(String json) {
                Log.v(TAG, "getFollowingsRes=" + json);
                if (pulldown) {
                    followings.clear();
                }
            ...
            protected Map<String, String> getParams() {
                ...
                Log.v(TAG, "getFollowingsParams=" + map);
                return map;
            }
        };
    ...
    public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.MyViewHolder> {
        ...
        ArrayList<HashMap<String, String>> followingsList;

        public RecyclerViewAdapter(ArrayList<HashMap<String, String>> followingsList) {
        ...
        public void onBindViewHolder(MyViewHolder holder, int position) {
            final HashMap<String, String> tempMap = followingsList.get(position);
            ...
            public void onClick(View v) {
                switch (v.getId()) {
                    case R.id.userImage:
                        ...
                        u.putExtra(Constants.TAG_USER_ID, followingsList.get(getAdapterPosition()).get(Constants.TAG_USERID));
                        startActivity(u);
                        break;
                    case R.id.followStatus:
                        if (GetSet.isLogged()) {
                            String userId = followingsList.get(getAdapterPosition()).get(Constants.TAG_USERID);
