...
public final class ImagePicker {
    ...
    public static Intent getPickImageIntent(Context context, String chooserTitle) {
        ...
        if (!appManifestContainsPermission(context, Manifest.permission.CAMERA) || hasCameraAccess(context)) {
            ...
            takePhotoIntent.putExtra(MediaStore.EXTRA_OUTPUT, FileProvider.getUriForFile(context, "com.app.external.ImagePicker",getTemporalFile(context)));
        ...
        if (resultCode == Activity.RESULT_OK && requestCode == PICK_IMAGE_REQUEST_CODE) {
            ...
            if (isCamera) {     /** CAMERA **/
                if(Build.VERSION.SDK_INT > Build.VERSION_CODES.KITKAT) {
                    selectedImage = FileProvider.getUriForFile(context, "com.app.external.ImagePicker", imageFile);
                } else {
